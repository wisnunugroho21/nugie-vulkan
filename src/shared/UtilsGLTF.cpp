...
void loadGLTF(GLTFContext& gltf, const char* glTFName, const char* glTFDataPath)
{
  ...
  gltf.vert      = loadShaderModule(ctx, "../../src/gltf/main.vert");
  gltf.frag      = loadShaderModule(ctx, "../../src/gltf/main.frag");
  gltf.animation = loadShaderModule(ctx, "../../src/gltf/animation.comp");

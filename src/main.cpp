...
int main()
{
  ...
  const VKPipeline11 pipelineOpaque(
      ...
      loadShaderModule(ctx, "../../src/main.vert"), loadShaderModule(ctx, "../../src/opaque.frag"));
  const VKPipeline11 pipelineTransparent(
      ctx, meshData.streams, kOffscreenFormat, app.getDepthFormat(), kNumSamples,
      loadShaderModule(ctx, "../../src/main.vert"), loadShaderModule(ctx, "../../src/transparent.frag"));
  const VKPipeline11 pipelineShadow(
      ctx, meshData.streams, lvk::Format_Invalid, ctx->getFormat(texShadowMap), 1,
      loadShaderModule(ctx, "../../src/shadow.vert"),
      loadShaderModule(ctx, "../../src/shadow.frag"));

  lvk::Holder<lvk::ShaderModuleHandle> vertOIT       = loadShaderModule(ctx, "../../src/QuadFlip.vert");
  lvk::Holder<lvk::ShaderModuleHandle> fragOIT       = loadShaderModule(ctx, "../../src/oit.frag");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> compBrightPass        = loadShaderModule(ctx, "../../src/BrightPass.comp");
  lvk::Holder<lvk::ComputePipelineHandle> pipelineBrightPass = ctx->createComputePipeline({ .smComp = compBrightPass });

  lvk::Holder<lvk::ShaderModuleHandle> compAdaptationPass        = loadShaderModule(ctx, "../../src/Adaptation.comp");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> compBloomPass     = loadShaderModule(ctx, "../../src/Bloom.comp");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> vertToneMap = loadShaderModule(ctx, "../../src/QuadFlip.vert");
  lvk::Holder<lvk::ShaderModuleHandle> fragToneMap = loadShaderModule(ctx, "../../src/ToneMap.frag");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> compSSAO        = loadShaderModule(ctx, "../../src/SSAO.comp");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> compBlur         = loadShaderModule(ctx, "../../src/Blur.comp");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> vertCombine       = loadShaderModule(ctx, "../../src/QuadFlip.vert");
  lvk::Holder<lvk::ShaderModuleHandle> fragCombine       = loadShaderModule(ctx, "../../src/combine.frag");
  ...
  lvk::Holder<lvk::ShaderModuleHandle> compCulling        = loadShaderModule(ctx, "../../src/FrustumCulling.comp");
